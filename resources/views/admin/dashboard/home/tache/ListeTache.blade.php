                                        ...
                                        @foreach ($taches as $tache)
                                            ...
                                            <td>{{ $tache->description }}</td>
                                                ...
                                                <td>
                                                    <!--
                        @if ($tache->status == 1)
    <form action="{{ url('admin/desactivetache/' . $tache->id) }}" method="POST">
                          @csrf
                          @method('PUT')
                          <input type="submit" class="btn btn-success" value="Désactive">
                        </form>
@else
    <form action="{{ url('admin/activetache/' . $tache->id) }}" method="POST">
                          @csrf
                          @method('PUT')
                      ...
                      -->
                                        ...
                                        <form action="{{ url('admin/admin/supprimerTache/' . $tache->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
