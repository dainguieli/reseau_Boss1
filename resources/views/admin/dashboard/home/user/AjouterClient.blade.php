                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="adresse" class="form-control" id="exampleInputEmail1"
                                            placeholder="Entrer votre Adresse" min="1">
                                    </div>         
                                    
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Couleur préférée</label>
                                        <input type="color" name="couleur_favori" class="form-control" id="exampleInputEmail1"
                                            placeholder="Entrer votre Couleur préférée" min="1" style="width: 10%;">
                                    </div>     
                                    <div class="form-group">
                                      <label>Genre</label>
                                      <select name="gender" required class="form-control select2" style="width: 100%;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date_de_naissance" class="form-control"
                                            id="exampleInputEmail1" placeholder="Entrer votre date de naissance"
                                            min="1">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contact" class="form-control" id="exampleInputEmail1"
                                            placeholder="Entrer votre contact" min="1">
                                    </div>
